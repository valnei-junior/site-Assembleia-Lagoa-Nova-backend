...
const { streamVideoByName } = require('./domains/media/controller/media-upload.controller');
...
app.get('/api/video/:name', streamVideoByName);
app.get('/api/v1/video/:name', streamVideoByName);
app.get('/video/:name', streamVideoByName);
